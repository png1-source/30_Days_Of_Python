...
print(company) # Inital oupout of company 

print(len(company)) # Outputting the length of the string comapny

print(company.upper()) # Outputting the sting in all capital letters
